...
(function () {
	...
	const BLOCK_DEFINITIONS = [
		...
		{ id: "row", category: "layout", label: "Row", icon: "bi-layout-text-window", description: "Single-column row.", html: '<div class="home-page__grid"><article class="card home-page__tile"><p>Row content</p></article></div>', transforms: ["columns"] },
		{ id: "columns", category: "layout", label: "Columns", icon: "bi-layout-three-columns", description: "Multi-column layout.", html: '<div class="home-page__grid"><article class="card home-page__tile"><p>Column 1</p></article><article class="card home-page__tile"><p>Column 2</p></article></div>', transforms: ["tiles"] },
